                            ...
                            <div key={module._id || mIndex} className="border border-slate-700 rounded-lg overflow-hidden bg-slate-800/50">
                                ...
                                <div className="divide-y divide-slate-700/50">
                                    {module.lessons?.map((lesson, lIndex) => {
                                        ...
                                        return (
                                            <div key={lesson._id || lesson.id} className={`p-4 flex items-center justify-between hover:bg-slate-700/30 transition-colors ${
                                                isCompleted ? 'border-l-4 border-green-500' : 'border-l-4 border-slate-700/50'
                                            }`}>
